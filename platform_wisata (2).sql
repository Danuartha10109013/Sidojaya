...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 15, 2024 at 02:15 PM
...
CREATE TABLE `users` (
  ...
  `role` enum('pengunjung','adminwisata','superadmin','') NOT NULL DEFAULT 'pengunjung',
  `acces_wisata` varchar(50) DEFAULT NULL,
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `fk_tiket` FOREIGN KEY (`id_tiket`) REFERENCES `tiket` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `reviews`
  ADD CONSTRAINT `id_rating` FOREIGN KEY (`id_ratings`) REFERENCES `ratings` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `id_user` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `id_wisata` FOREIGN KEY (`id_wisata`) REFERENCES `wisata` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `wisata`
--
ALTER TABLE `wisata`
  ADD CONSTRAINT `wisata_ibfk_1` FOREIGN KEY (`id_kategori`) REFERENCES `kategori_wisata` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `wisata_ibfk_2` FOREIGN KEY (`id_galeri`) REFERENCES `galeri` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
